...
config.AUTHOR_RESOURCES_JS = [
    "es6-promise.js", "author-init.js",
    "author-dom.js", "author-main.js", "author-ask.js",
    "author-json-content.js", "author-json.js", "author-games.js",
    "author-table-columns.js", "author-table.js",
...
/**
 * Other library files, local to the repository root, required for the author.
 *
 * NOTE: These files are referenced by `grunt`.
 * @see Gruntfile.js
 *
 * @type {Array.<string>}
 */
config.AUTHOR_RESOURCES_JS_LIB = [
...
/**
 * Directory to upload files into. MUST be writeable by the node process running
 * the socket server), and MUST point to the same place between the socket
 * server and the HTTP server.
 * To limit the size of files that can be uploaded here, set the
 * AUTHOR_MAX_FILE_SIZE constant in
 * modules/socketServers/authorSocketHandler.js.
 *
 * @type {string}
 */
config.UPLOADS_DIR = path.join(__dirname, "uploads");
